...
#define W			9 // Total size of fixed-point representation. Must be W >= (I+MAN_BITS)
#define I			2  // Size of integer part of fixed-point (1 bit sign + 1 bit integer)
#define MAN_BITS	7  // Size of fractional part. Vary this number to increase/decrease the resolution.
